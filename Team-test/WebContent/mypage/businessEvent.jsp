...
<link href="css/businessEvent.css" rel="stylesheet">
		...
		<section id="boardWrite">
			...
			<form action="./BusinessEventPro.mp" method="post" enctype="multipart/form-data" name="boardform" id="writeF">
				...
				<table>
					...
					<tr>
						<td><label for="board_name" class="menu">나의 음식점</label></td>
					</tr>
					<tr>
						<td>
						<div class="a1">
						<div class="store_name"> [ ${storeBean.store_name } ]</div>
						<img class="store_image" alt="" src="./files/${storeBean.store_image }"> <br>
						 &nbsp;${storeBean.store_address} <br>
						 &nbsp;# ${storeBean.store_category }
						</div>
					</tr>
					<tr>
