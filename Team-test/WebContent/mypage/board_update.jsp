...
<body>
	<div id="container">
		...
		<section id="boardWrite">
			<h2>리얼 후기 수정</h2>
			<form action="BoardUpdatePro.mp" method="post" enctype="multipart/form-data" name="boardform" id="writeF">
				...
				<table>
					...
					<tr>
						<td>
						<input type="text" name="board_subject"	id="board_subject" disabled="disabled" class="a" value="음식점 이름">
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
						<input type="text" name="board_subject" id="board_subject" required="required" class="a">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
						<input type="text" name="board_rating" id="board_rating" required="required" class="a">
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
						<textarea name="board_content" id="board_content" cols="30" rows="12" required="required" class="a">
						</textarea></td>
					</tr>
					<tr>
				...
				<input type="submit" value="업데이트" class="submit_com"> <input
