...
<link href="css/user_update2.css" rel="stylesheet">
		...
		<section id="myPage">
			...
			<form action = "UserUpdatePro.mp" method="post" id = "JoinForm" name="JoinForm" >
				...
				<div class="Join">
					...
					<input class="a dupli_check disabled" type="text" maxlength="16" placeholder="아이디" value="${memberBean.user_id}" name="user_id" required="required" readonly="readonly"> 
					
					<input class="a nick_check disabled" type="text" maxlength="16" placeholder="닉네임" value="${memberBean.user_nickname}" name="user_nickname" required="required" readonly="readonly">
